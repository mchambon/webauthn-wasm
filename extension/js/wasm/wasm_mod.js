 ...
 * @param {number} ptr
 */
export function free_string(ptr) {
    _assertNum(ptr);
    wasm.free_string(ptr);
}

const AuthenticatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_authenticator_free(ptr >>> 0, 1));
...
export class Authenticator {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        AuthenticatorFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_authenticator_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.authenticator_new();
        this.__wbg_ptr = ret >>> 0;
        AuthenticatorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    hello_from_auth() {
        ...
        try {
            ...
            const ret = wasm.authenticator_hello_from_auth(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @returns {string}
     */
    make_credential(request_js) {
        let deferred2_0;
        let deferred2_1;
        try {
            if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
            _assertNum(this.__wbg_ptr);
            const ret = wasm.authenticator_make_credential(this.__wbg_ptr, request_js);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
     ...
     * @returns {any}
     */
    get_assertion(request_js) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ret = wasm.authenticator_get_assertion(this.__wbg_ptr, request_js);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    list_credentials(rp_id) {
        if (this.__wbg_ptr == 0) throw new Error('Attempt to use a moved value');
        _assertNum(this.__wbg_ptr);
        const ptr0 = passStringToWasm0(rp_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.authenticator_list_credentials(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
